import { AgentOfficeStorage, WatchListener, WatchState, SenderInfo, SessionRow, ConfigRow, MessageRow, CronJobRow, CronHistoryRow, CronRequestRow, TaskRow, TaskHistoryRow } from './storage.js';
export type { WatchListener, WatchState, SenderInfo };
export declare class MockAgentOfficeStorage implements AgentOfficeStorage {
    private sessions;
    ...
    private cronJobs;
    private cronJobIdCounter;
    private cronHistory;
    private cronHistoryIdCounter;
    private cronRequests;
    private cronRequestIdCounter;
    private tasks;
    private taskIdCounter;
    private taskHistory;
    private taskHistoryIdCounter;
    private listeners;
    private closed;
    close(): Promise<void>;
    isClosed(): boolean;
...
export declare function createMockStorage(): MockAgentOfficeStorage;
